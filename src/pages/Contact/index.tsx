			...
			<div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center lg:items-start justify-between gap-6 lg:gap-9 mt-9">
				<div>
					<h1 className="text-5xl font-bold text-center md:text-left text-slate-700">
						<span className="text-6xl text-primary">Contact</span> <br />{" "}
						HydroKleen <br /> Bangladesh
					</h1>
					<div className="text-xl flex flex-row items-center gap-3 mx-auto lg:ml-0 w-fit mt-12">
						<Link
				...
				<div className="[&>p]:my-3 [&>p>span]:font-bold [&>p>span]:text-primary text-center md:text-start">
					<p>
						We offer <span>Expert service</span> to all of our customers. You
						can always count on Hydrokleen Experts to reach out to you as soon
						as possible. We use professional equipment to find the source of
						your air conditioning problems and fix them.
					</p>

					<div className="w-full bg-white p-5 rounded-xl shadow-lg mt-7">
						<div className="mb-6">
							<p className="text-2xl flex flex-row items-center gap-2 text-primary font-bold justify-center lg:justify-start mb-2">
						...
						<div className="m-7 flex flex-col md:flex-row items-center justify-between gap-4">
							<Link
								to="tel:+8801902464646"
								className="font-semibold text-slate-700"
							>
								<span className="text-2xl text-primary font-bold">Phone</span>{" "}
								<br /> 01902-464646 (9AM - 7PM)
							</Link>
							<Link
								to="mailto:service@hydrokleen.com.bd"
								className="font-semibold text-slate-700"
							>
								<span className="text-2xl text-primary font-bold">Email</span>{" "}
								<br /> service@hydrokleen.com.bd
							</Link>
