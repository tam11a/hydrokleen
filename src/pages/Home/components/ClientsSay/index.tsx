	...
	return (
		<div className="grid grid-cols-7 gap-2">
			<div className="col-span-7 md:col-span-4">
				<h2 className="text-3xl font-bold text-end mt-4">
					What Our
					<br />
					<span className="text-primary-600">Clients Say</span>
				</h2>
				<p className="text-sm font-semibold text-slate-600 text-end mb-5 mt-3">
				...
				>
					{feedbacks.map((feedback, index) => (
						<SwiperSlide key={index}>
							<div className="flex flex-col items-end p-3 justify-center">
								<p className="text-sm font-semibold text-right text-slate-600 max-w-lg">
									" {feedback.feedback} "
								</p>
								<div className="flex flex-row gap-2 mt-3 items-center justify-start">
									<div>
										<h3 className="text-xl font-bold text-end">
											{feedback.name}
										</h3>
										<p className="text-xs font-semibold text-end text-slate-600">
				...
				<div className="flex flex-row items-center justify-end text-primary-600">
					<IconButton
						color="primary"
						id="prev-review"
