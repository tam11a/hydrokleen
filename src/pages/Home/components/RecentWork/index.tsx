...
const RecentWork: React.FC = () => {
	return (
		<>
			<div className="grid grid-cols-1 md:grid-cols-7 items-center  mt-20">
				<div className="col-span-3">
					<h2 className="text-4xl text-center text-slate-700 font-bold  mt-9 md:text-right">
						Recent <span className="text-primary-600">Works</span>
					</h2>
					<p className="text-lg font-semibold text-slate-600 text-center mb-4 mt-1 md:text-right">
						Explore Our Recent Works
					</p>
					<p className="max-w-2xl [&>span]:text-primary-600 text-base text-slate-600 [&>span]:font-semibold my-3 text-center md:text-right ml-auto">
				...
				<div className="grid grid-cols-2 col-span-4 gap-2 max-w-4xl mx-auto mt-7">
					<div>
						<img
