export const faqs: IFaq[] = [
	...
	{
		title:
			"What kind of maintenance is required for an AC unit installation in your home?",
		description:
...
export const subserviceSection: ISubserviceSection = {
	headerTitle: (
		<>
			AC Installation <br /> <span>& Shifting</span>
		</>
	),
	description:
